...
- (void)layoutSubviews {
    ...
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:detailsLabel.lineBreakMode attributes:@{NSFontAttributeName:detailsLabel.font} context:nil].size;
