...
-(void)addControl{
    ...
    [vDeleteButton setBackgroundColor:[UIColor getColor:@"ff3b30"]];
    ...
    [vMoreButton setBackgroundColor:[UIColor getColor:@"ff8400"]];
    [vMoreButton setTitle:@"默认" forState:UIControlStateNormal];
