...
+ (UIImage *) getLaunchImage {
    ...
    if (screenWidth == 640 && screenHeight == 1136) {
        image = [UIImage imageNamed:@"LaunchImage-640-1136.png"];
    }
    else if (screenWidth == 320 && screenHeight == 480) {
        image = [UIImage imageNamed:@"LaunchImage-320-480.png"];
    }
    else if (screenWidth == 640 && screenHeight == 960) {
        image = [UIImage imageNamed:@"LaunchImage-640-960.png"];
    }
    else if (screenWidth == 750 && screenHeight == 1334) {
        image = [UIImage imageNamed:@"LaunchImage-750-1334.png"];
    }
    else if (screenWidth == 1242 && screenHeight == 2208) {
        image = [UIImage imageNamed:@"LaunchImage-1242-2208.png"];
    }
        ...
        image = [UIImage imageNamed:@"LaunchImage-1536-2048.png"];
    }
    else if (screenWidth == 768 && screenHeight == 1024) {
        image = [UIImage imageNamed:@"LaunchImage-768-1024.png"];
    }
    if (!image) {
